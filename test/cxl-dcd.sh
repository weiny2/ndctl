...
#
# The test devices have 2G of non DC capacity.
#
# The testing centers around 2 extents.  One is pre-existing on start and is at
# a 256MB offset of 256MB length.  The other is at offset 0 and 64MB in length.
# After the initial pre-existing extent test both are added and removed as
# needed.
#
# | 2G non- |      DC region                                        |
# |  DC cap |                                                       |
